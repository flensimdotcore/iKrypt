...
#define MAIN_BUTTON BUTTON1_PIN
#define LEFT_BUTTON BUTTON2_PIN
#define TOP_BUTTON BUTTON3_PIN
#define RIGHT_BUTTON BUTTON4_PIN
#define BOTTOM_BUTTON BUTTON5_PIN
